...
def get_values(course,promo,cursus,project):
    ...
    values = {
        ...
        "entry.1770104696" : os.getenv('mail'),
...
for course in ['DE']:
    for promo in ['JAN24','FEB24','MAR24','APR24','MAY24','JUN24','JUL24','AUG24']:
        for cursus in ['Bootcamp - Full-time', 'Continu - Part-time']:
            for project in ['NY News', 'Satisfaction client', 'OPA', 'Job market', 'Ecobalyse', 'DST Airlines']:
